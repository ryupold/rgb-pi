...
(function(window, document, undefined) {
    ...
    function ColorPicker(slideElement, pickerElement, callback) {
		...
		addEventListener(this.slideElement, 'mousemove', slideListener(this, this.slideElement, this.pickerElement));
        addEventListener(this.pickerElement, 'mousemove', pickerListener(this, this.pickerElement));
